...
<div class="container">
            ...
            <div class="panel panel-default">
                <div class="panel-heading c-list">
                    ...
                    <ul class="pull-right c-controls">
                        <li><a href="#add-contact-modal" data-toggle="tooltip" data-placement="top" title="Add Contact"><i class="glyphicon glyphicon-plus"></i></a></li>
                ...
                <ul class="list-group" id="contact-list">
                    ...
                    <li class="list-group-item">
                        <div class="col-xs-12 col-sm-3">
                            <img src="https://gravatar730.files.wordpress.com/2023/10/logo.png?w=240" alt="Scott Stevens" class="img-responsive img-circle" />
                        </div>
                        <div class="col-xs-12 col-sm-9">
                            <span class="name">{{$contact->name}}</span><br />
                            <span class="glyphicon glyphicon-earphone text-muted c-info" data-toggle="tooltip" title="{{$contact->contact}}"></span>
                            <span class="visible-xs"> <span class="text-muted">{{$contact->contact}}</span></span>
                            <span class="fa fa-envelope text-muted c-info" data-toggle="tooltip" title="{{$contact->email}}"></span>
                            <span class="visible-xs"> <span class="text-muted">{{$contact->email}}</span></span>
                            <span class="fa fa-edit text-muted c-info" data-toggle="tooltip" title="Edit Contact" data-name="{{$contact->name}}" data-contact="{{$contact->contact}}" data-email="{{$contact->email}}" onclick="editContactModal(this)"></span>
                            <span class="fa fa-times text-muted c-info" data-toggle="tooltip" title="Delete Contact" data-name="{{$contact->name}}" data-id="{{$contact->id}}" onclick="deleteContact(this)"></span>
                        </div>
    ...
    <div id="add-contact-modal" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="addContactLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-danger alert-success mb-1" style="display: none;">
                    </div>
